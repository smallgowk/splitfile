...
//    public static final int TYPE_NORMAL = 0;
    ...
    public String getValueForField(String fieldName) {
        ...
        Class aClass = NewProductAmz.class;
...
//            Logger.getLogger(ProductAmz.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void copyAllProduct(NewProductAmz productAmz) {
        Class aClass = NewProductAmz.class;
...
//            Logger.getLogger(ProductAmz.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void copyProduct(NewProductAmz productAmz) {
        Class aClass = NewProductAmz.class;
...
//            Logger.getLogger(ProductAmz.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public void updateRapidImageUrl(ArrayList<String> productImages) {
        ...
        main_image_url = ScrapUtil.processImgUrl(productImages.get(0));
        ...
        for (int i = 1, size = productImages.size(); i < size; i++) {
            ...
            url = ScrapUtil.processImgUrl(url);
